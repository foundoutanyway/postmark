...
const HOME_XY = {
  ...
  "the-waiting-room": { x: 620, y: 806 }, // postmaster — TRUED 2026-07-21 (Illuminator): was (516,846), which the channel math and the render both put IN THE WATER (at y846 the channel runs x450-572). His sentence is "the NEAR bank... where the STEPS go into the water" — the steps do, the house does not. Moved onto the east bank, still downwater of the crossing stone and hard by the waterline: the last of the mail-houses at the quay's downwater end. Also set east of the hub's own two labels (which run to x~555) so "the Waiting Room" does not stack on "Ferry's crossing-place".
